...
export async function POST(req: NextRequest) {
  ...
  const apuracao = await prisma.conciliacaoBancariaApuracao.create({
    data: {
      ...
      totalFechamentoTotalDia: resultado.totais.totalFechamentoTotalDia,
      totalDivergenciaValor: resultado.totais.totalDivergenciaValor,
      ...
      dias: {
        create: resultado.dias.map((d) => ({
          ...
          saldoInicialRazao: d.saldoInicialRazao,
          saldoFinalRazao: d.saldoFinalRazao,
          saldoInicialExtrato: d.saldoInicialExtrato,
          saldoFinalExtrato: d.saldoFinalExtrato,
